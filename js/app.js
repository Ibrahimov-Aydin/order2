(() => {
    ...
    function menuInit() {
        if (document.querySelector(".button-menu")) document.addEventListener("click", (function(e) {
            if (bodyLockStatus && e.target.closest(".button-menu")) {
                bodyLockToggle();
    ...
    function initSliders() {
        if (document.querySelector(".reviews__slider")) new core(".reviews__slider", {
            ...
            loop: true,
            navigation: {
                prevEl: ".navigation__prev-button_review",
                nextEl: ".navigation__next-button_review"
            },
            on: {}
        });
        if (document.querySelector(".experts__slider")) new core(".experts__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            speed: 1e3,
            navigation: {
                prevEl: ".navigation__prev-button_experts",
                nextEl: ".navigation__next-button_experts"
            },
            on: {}
        });
    }
